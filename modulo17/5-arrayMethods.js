...
//         - Añadir 3 usuarios mas con las mismas propiedades (id, name, age)
let newArray =users.concat({id: 10, name: "Fran", age: 31},{id: 11, name: "Luis", age: 38},{id: 12, name: "Dave", age: 24},)

console.log(newArray)
//         - Recorrer el nuevo array con usuarios y mostrar usando console.log el mensaje "Hola me llamo name y tengo age años"
newArray.forEach(function(item) { 
    console.log (`Hola me llamo ${item.name} y tengo ${item.age} años`)
});

//         - Buscar un usuario que tenga 31 años y mostrar ese usuario por consola

let user = newArray.find(function(item) {
      return item.age === 31
})
console.log('Se encontro con la edad de 31 a:')
console.log(user)
...
newArray.forEach(function(item) {
   ...
   if(item.name==='Fran'){
    console.log('Se encontro con el Nombre de Fran a:')
    console.log(item)
   }  
});
